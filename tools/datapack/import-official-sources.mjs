...
function buildFixture(inventory, input) {
  ...
  const hasSelectedScheduleSource = selectedSources.some((source) => sourceDomainEnabled([source], "schedule_timetable"));
    ...
    packs: [
      {
        ...
        officialOdFareQuotes: input.officialOdFareQuotes ?? [],
        routeServiceArtifactEvidence: input.routeServiceArtifactEvidence ?? [],
