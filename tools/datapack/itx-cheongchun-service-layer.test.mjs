...
test("test-only ADMITTED timetable은 ITX trip·stop·EXPRESS edge를 materialize한다", async (context) => {
  ...
  try {
    ...
    assert.equal(evidence.canonical_pack_sha256, "757122c843575401c75b9705283c691361e9f1b259d1b82d26cff949b9729cf9");
    assert.equal(evidence.canonical_pack_sqlite_sha256, "e6e6842e29b1f39a89d82b08ee0b012d1b2345b33ad6dce284a456dc989363bf");
  } finally {
    database.close();
  }
});
