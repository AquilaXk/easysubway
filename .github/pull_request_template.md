...
- A등급(API, schema, data, security, deployment, artifact, release, CI workflow·계약 테스트·release gate 변경): .github/PULL_REQUEST_TEMPLATE/full.md를 사용합니다.
- B/C등급(일반 코드 변경·낮은 위험 maintenance): .github/PULL_REQUEST_TEMPLATE/short.md 내용으로 교체합니다.
- 웹 UI에서는 ?template=full.md 또는 ?template=short.md 쿼리를 쓸 수 있습니다.
- gh CLI에서는 gh pr create --template .github/PULL_REQUEST_TEMPLATE/full.md 또는 gh pr create --template .github/PULL_REQUEST_TEMPLATE/short.md를 사용합니다.
