...
FROM (
    VALUES
        ...
        (20, 'REPORT_CONFIRMED', '제보 확인', '제보 확인 후 상태 변경', 20),
        (30, 'SOURCE_TIMEOUT', '원천 응답 지연', '원천 데이터 응답 시간 초과', 10),
        (30, 'VALIDATION_ERROR', '확인 실패', '수집 산출물 확인 실패', 20),
