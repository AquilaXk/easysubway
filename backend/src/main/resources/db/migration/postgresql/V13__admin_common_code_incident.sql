...
VALUES
    ('DATA_OPERATOR', 'admin.operations.manage', CURRENT_TIMESTAMP),
    ('SECURITY_ADMIN', 'admin.operations.manage', CURRENT_TIMESTAMP),
    ('SUPER_ADMIN', 'admin.operations.manage', CURRENT_TIMESTAMP);
