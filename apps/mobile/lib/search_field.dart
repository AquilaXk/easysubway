            ...
            child: Padding(
              ...
              child: Row(
                children: [
                  ...
                  Expanded(
                    // 바깥 SizedBox(56)가 터치타겟 높이를 차지하고, 그 안 Center가
                    // 고정 높이(48) 단일 줄 TextField를 세로 중앙에 놓는다. 필드를
                    // 48로 고정하면 홈 상단바·역 검색 AppBar 등 바깥 레이아웃과
                    // 무관하게 히트/semantics 영역이 48px 게이트를 넘고, 아래 비대칭
                    // 세로 패딩의 정렬 보정이 두 화면에서 동일하게 동작한다. 여러 줄
                    // (expands) 트릭을 쓰면 실기기에서 입력 텍스트와 IME 조합 밑줄이
                    // 첫 줄로 렌더돼 박스 상단에 붙는 회귀가 있어 단일 줄 필드를
                    // 유지한다.
                    child: SizedBox(
                      height: EasySubwayTouchTarget.general,
                      child: Center(
                        child: SizedBox(
                          height: EasySubwayTouchTarget.iconOnly,
                          child: TextField(
                            ...
                            // 6px 더 주고 하단을 6px 덜 줘(21/9) 고정 필드 높이(48,
                            ...
                            decoration: InputDecoration(
                              ...
                              isDense: true,
                              contentPadding:
                                  const EdgeInsets.fromLTRB(0, 21, 0, 9),
