class ProductionScopeCopy {
  ...
  static const stationSearchNotice =
      '$supportedClaimKo 범위의 역 정보를 먼저 보여주고, 벗어난 지역은 $unsupportedRegionActionKo가 필요해요.';
  static const helpNotice =
      '현재 지원 범위는 $supportedClaimKo입니다. 범위 밖 정보는 준비 중이거나 $unsupportedRegionActionKo가 필요할 수 있어요.';
}
