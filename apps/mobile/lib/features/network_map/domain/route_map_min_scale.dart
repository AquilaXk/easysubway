...
/// 화면px/원본단위 중앙값 ÷ devicePixelRatio(2.8125)로 산출했다. 중앙값의 모집단은
/// 덤프와 fixture에 함께 있는 역들로 만든 **모든 역 쌍**의 거리비다.
///
/// 값 조정은 **이 표 한 곳**에서 한다. 키는 표시용 권역명
/// ([routeMapDisplayRegionName] 정규화 결과)이다. 아래 노선망 치수는
...
const Map<String, double> kRouteMapMinScaleByRegion = <String, double>{
  // 덤프 공통역 53개 · 노선망 9996×4541.
  // 주의: 파일 상단 [이 하한이 보장하지 못하는 것] (2) — 실측 곡선상 팬 jank가
  // 큰 구간이다(수도권 0.16에서 7.4%, 그 아래는 더 나쁨). 오너 지정값이므로
  // 그대로 두되, 하한 상향이나 별도 최적화가 필요하다(#2600).
  '부산': 0.1128,
  // 덤프 공통역 49개 · 노선망 4102×1965.
  '대구': 0.2216,
  // 덤프 공통역 349개 · 노선망 3361×2519.
  '수도권': 0.2261,
  // 덤프 공통역 19개 · 노선망 1250×1220.
  '광주': 0.2399,
  // 덤프 공통역 22개 · 노선망 1044×1320.
  '대전': 0.3119,
};
