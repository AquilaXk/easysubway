...
//   대전  22/22  (전 역 매치)
//   수도권 652   (#2068 부산 4차 2단계: 동명이역 라벨을 이름당 리스트로 보존하고
//               역별 최근접 1:1 매칭으로 바꿔, 양평 2역(경의중앙선·수인분당선)이
//               각자 자기 라벨을 갖는다 — 이전 651에서 +1. 미매치 4: 도라산·
//               총신대입구·하남검단산역 등 sidecar 미표기.)
//   부산  145    (#2068 부산 5차: 오너 라벨 <text> 표기차 4역을 BUSAN.canonicalRules로
//               정합(벡스코(시립미술관)→벡스코, 부산역→부산, 경성대·부경대→경성대.
//               부경대, 국제금융센터·부산은행→국제금융센터.부산은행) — 이전 143에서
//               +2(부산 +1, 벡스코 2후보 중 1). 미매치 2: 부전·벡스코 동해선 노드는
//               같은 이름의 물리역이 별개 station_id로 모델링됐으나 오너 SVG 라벨이
//               1개뿐이라 최근접 1개만 매치되고 나머지는 미매치로 남는다(동명 폴백은
//               solveRouteMapLabelLayout이 시각 억제 — LABELCOUNT 부전=1·벡스코=1).
//               동래는 datapack이 단일 환승 노드로 모델링해 라벨이 둘이어도 1개만
//               귀속된다 — 별도 범위.)
