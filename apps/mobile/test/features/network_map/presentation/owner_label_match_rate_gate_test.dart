...
//   부산  143    (#2068 좌천 오병합 분리: 1호선·동해선 좌천을 별개 station_id로
//               나눠 각자 자기 라벨을 갖고, 오병합이 왜곡했던 1호선 인접 배치가
//               재정렬돼 그 인접역 라벨도 복원됐다 — 이전 141에서 +2. 미매치 4:
//               벡스코·부산 등 표기차 + 게이트 제외분. 동래는 datapack이 단일
//               환승 노드로 모델링해 라벨이 둘이어도 1개만 귀속된다 — 별도 범위.)
